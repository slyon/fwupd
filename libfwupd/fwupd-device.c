 ...
 * @self: a #FwupdDevice
 * @inhibit_kind: the #FwupdDeviceFlags, e.g. #FWUPD_DEVICE_INHIBIT_KIND_SYSTEM_POWER_TOO_LOW
 *
 ...
 **/
void
fwupd_device_add_inhibit_kind(FwupdDevice *self, FwupdDeviceFlags inhibit_kind)
{
	FwupdDevicePrivate *priv = GET_PRIVATE(self);
	g_return_if_fail(FWUPD_IS_DEVICE(self));
	if (inhibit_kind == 0)
 ...
 **/
void
fwupd_device_remove_inhibit_kind(FwupdDevice *self, FwupdDeviceFlags inhibit_kind)
{
	FwupdDevicePrivate *priv = GET_PRIVATE(self);
	g_return_if_fail(FWUPD_IS_DEVICE(self));
	if (inhibit_kind == 0)
 ...
 * @self: a #FwupdDevice
 * @inhibit_kind: the #FwupdDeviceFlags
 *
 ...
 **/
gboolean
fwupd_device_has_inhibit_kind(FwupdDevice *self, FwupdDeviceFlags inhibit_kind)
{
	FwupdDevicePrivate *priv = GET_PRIVATE(self);
	g_return_val_if_fail(FWUPD_IS_DEVICE(self), FALSE);
